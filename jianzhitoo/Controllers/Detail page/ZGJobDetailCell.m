...
@implementation ZGJobDetailCell
...
//        self.selectedBackgroundView.backgroundColor = [UIColor clearColor];
        ...
        self.jobImg = [[UIImageView alloc]initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, 160)];
        ...
        self.jobNameLab.font = [UIFont systemFontOfSize:JobDetailJobNameSize];
        ...
        self.mapBtn.titleLabel.font = [UIFont systemFontOfSize:APP_FONT_SIZE_NORMAL];
        self.mapBtn.frame = CGRectMake(SCREEN_WIDTH - JobDetailMainSpacing - JobDetailMapBtnWidth, 14, JobDetailMapBtnWidth, 21);
        ...
        self.schoolmateTitleLab.font = [UIFont systemFontOfSize:JobDetailJobNameSize];//[UIFont fontWithName:APP_FONT_NORMAL size:];
        ...
        self.schoolmateImg1.userInteractionEnabled = YES;
        self.schoolmateImg1.tag = 700;
        ...
        self.schoolmateImg2.userInteractionEnabled = YES;
        self.schoolmateImg2.tag = 701;
        ...
        self.schoolmateImg3.userInteractionEnabled = YES;
        self.schoolmateImg3.tag = 702;
        ...
        self.schoolmateImg4.userInteractionEnabled = YES;
        self.schoolmateImg4.tag = 703;
        ...
        self.schoolmateImg5.userInteractionEnabled = YES;
        ...
        [self.joinBtn setBackgroundImage:[ZGUtility imageWithColor:JobDetailSchoolJoinBtnColorNormal size:CGSizeMake(JobDetailSchoolJoinBtnWidth, JobDetailSchoolJoinBtnHeight)] forState:UIControlStateNormal];
        [self.joinBtn setBackgroundImage:[ZGUtility imageWithColor:JobDetailSchoolJoinBtnColorPressed size:CGSizeMake(JobDetailSchoolJoinBtnWidth, JobDetailSchoolJoinBtnHeight)] forState:UIControlStateHighlighted];
        [self.joinBtn setBackgroundImage:[ZGUtility imageWithColor:JobDetailSchoolJoinBtnColorDisabled size:CGSizeMake(JobDetailSchoolJoinBtnWidth, JobDetailSchoolJoinBtnHeight)] forState:UIControlStateDisabled];
        self.joinBtn.titleLabel.font = [UIFont systemFontOfSize:15];
